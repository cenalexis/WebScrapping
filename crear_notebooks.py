...
CT_CONFIG = [
    ...
    "# Clave = slug de URL: /empleos-en-{clave}  (formato: provincia-en-ciudad)\n",
    "CIUDADES = {\n",
    ...
    "    'bolivar-en-guaranda'                             : 'Guaranda (Bolivar)',\n",
    "    'canar-en-azogues'                                : 'Azogues (Canar)',\n",
    "    'carchi-en-tulcan'                                : 'Tulcan (Carchi)',\n",
    "    'el-oro-en-machala'                               : 'Machala (El Oro)',\n",
    "    'manabi-en-manta'                                 : 'Manta (Manabi)',\n",
    "    'manabi-en-portoviejo'                            : 'Portoviejo (Manabi)',\n",
    "    'esmeraldas-en-esmeraldas'                        : 'Esmeraldas (Esmeraldas)',\n",
    "    'santo-domingo-de-los-tsachilas-en-santo-domingo' : 'Santo Domingo (Tsachilas)',\n",
    "    'los-rios-en-babahoyo'                            : 'Babahoyo (Los Rios)',\n",
    "    'guayas-en-milagro'                               : 'Milagro (Guayas)',\n",
    "    'guayas-en-daule'                                 : 'Daule (Guayas)',\n",
    "    'santa-elena-en-santa-elena'                      : 'Santa Elena (Santa Elena)',\n",
    "    'sucumbios-en-nueva-loja'                         : 'Nueva Loja / Lago Agrio (Sucumbios)',\n",
